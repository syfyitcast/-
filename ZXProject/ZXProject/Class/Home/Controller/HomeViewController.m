...
- (NSArray *)items{
    if (_items == nil) {
        _items = @[@"NotificationViewController",@"WorkFlowController",@"AttendanceController",@"WorkManagerController",@"EventsViewController",@"InspectionViewComntroller",@"onFoucsController",@"onFoucsController",@"ProjectReviewController",@"onFoucsController",@"onFoucsController",@"onFoucsController"];
    }
    return _items;
}
