...
#warning proxy setting
    
//    if ([Tool hasSetProxy:request.url]) {
//        NSError *proxyError = [[NSError alloc]initWithDomain:request.url code:-999 userInfo:nil];
//        [self xm_failureWithError:proxyError forRequest:request];
//        return;
//    }
